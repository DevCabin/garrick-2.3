          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Garrick Options', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Garrick Options', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Garrick Options updated.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Garrick Options reset.', 'option-tree' ) ),
    ...
    $ot_register_pages_array =  array( 
      ...
      array(
        ...
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => __( 'Garrick Options UI', 'option-tree' )
          ),
          array(
            'id'          => 'import',
        ...
        'settings'        => array(
          array(
            ...
            'label'       => __( 'Garrick Options UI Builder', 'option-tree' ),
          ...
          array(
            'id'          => 'import_data_text',
            'label'       => __( 'Garrick Options', 'option-tree' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
